...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { activity_id: @participation.activity_id, status: @participation.status, user_id: @participation.user_id }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { activity_id: @participation.activity_id, status: @participation.status, user_id: @participation.user_id }
    assert_redirected_to participation_path(assigns(:participation))
  end
